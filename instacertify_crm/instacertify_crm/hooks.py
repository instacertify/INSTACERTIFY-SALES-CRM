...
app_description = "Pure ERPNext 16 consulting ERP for Instacertify — leads, quotes, labs, samples, projects, HR lite & assets"
...
website_route_rules = [
	...
	{"from_route": "/emp/<path:token>", "to_route": "emp"},
]
