...
def _quote_payload(doc):
	return {
		...
		"about_header": doc.about_header or "About",
		...
		"sample_requirements_header": doc.sample_requirements_header or "Sample Required",
		...
		"banking_header": doc.banking_header or "Banking Details",
